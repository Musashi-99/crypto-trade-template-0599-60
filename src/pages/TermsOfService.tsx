            ...
            <div className="glass glass-hover rounded-xl p-8 md:p-12 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-2 text-muted-foreground">
                  <p>📧 Email: <a href="mailto:orbitohq@gmail.com" className="text-primary hover:underline">orbitohq@gmail.com</a></p>
                  <p>📞 Phone: <a href="tel:+923121234567" className="text-primary hover:underline">+92 312 1234567</a></p>
